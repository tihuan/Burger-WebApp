...
before_filter :checkAnimal
  ...
  def burger_params
    params.require(:burger).permit(
      :buns, :patties,:cheese, :onions, :tomatoes,
      :lettuce, :spreads, :others, :cutinhalf, :cooklevel,
      :heavymustardbeef, :normalmustardbeef, :normalbeef, :nosaltbeef,
      :meltcheese, :coldcheese,
